...
# Email nhận thông báo (có thể cấu hình qua biến môi trường)
# Ưu tiên NOTIFY_RECEIVER_EMAIL, fallback về RECEIVER_EMAIL để tương thích
RECEIVER_EMAIL = os.getenv("NOTIFY_RECEIVER_EMAIL") or os.getenv(
...
def gui_email_thong_bao(tieu_de: str, noi_dung: str):
    ...
    if not SMTP_USER or not SMTP_PASSWORD:
        print(
            "CẢNH BÁO: Chưa cấu hình SMTP_USER hoặc SMTP_PASSWORD. Không thể gửi email."
        )
        return False
